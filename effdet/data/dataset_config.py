...
class Coco2017Cfg(CocoCfg):
    ...
    splits: Dict[str, dict] = field(default_factory=lambda: dict(
        train=dict(ann_filename='merged_6_train/results/merged/annotations/merged.json', img_dir='merged_6_train/results/merged/images', has_labels=True),
        val=dict(ann_filename='merged_6_val/results/merged/annotations/merged.json', img_dir='merged_6_val/results/merged/images', has_labels=True),
        #val=dict(ann_filename='datasets/coco/annotations/instances_val2017.json', img_dir='datasets/coco/val2017', has_labels=True),
        ...
        test=dict(ann_filename='Highway_drop_inlets.v1-vdot_coco.coco/coco_and_dropinlets_annotations/test_annotations/test.json', img_dir='Highway_drop_inlets.v1-vdot_coco.coco/coco_and_dropinlets/test', has_labels=True)
    ))
    ...
    '''variant: str = '2017'
    splits: Dict[str, dict] = field(default_factory=lambda: dict(
        train=dict(ann_filename='Highway_drop_inlets.v1-vdot_coco.coco/coco_and_dropinlets_annotations/train_annotations/train.json', img_dir='Highway_drop_inlets.v1-vdot_coco.coco/coco_and_dropinlets/train', has_labels=True),
        val=dict(ann_filename='Highway_drop_inlets.v1-vdot_coco.coco/coco_and_dropinlets_annotations/valid_annotations/valid.json', img_dir='Highway_drop_inlets.v1-vdot_coco.coco/coco_and_dropinlets/valid', has_labels=True),
        test=dict(ann_filename='Highway_drop_inlets.v1-vdot_coco.coco/coco_and_dropinlets_annotations/test_annotations/test.json', img_dir='Highway_drop_inlets.v1-vdot_coco.coco/coco_and_dropinlets/test', has_labels=True),
        #testdev=dict(ann_filename='annotations/image_info_test-dev2017.json', img_dir='test2017', has_labels=False),
    ))'''
