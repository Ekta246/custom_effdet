...
parser.add_argument('--model', default='efficientdet_d0', type=str, metavar='MODEL',
...
#####set the pretrained flag to True####################
...
parser.add_argument('--epochs', type=int, default=230, metavar='N',
...
def train_epoch(
    ...
    for batch_idx, (input, target) in enumerate(loader):
        ...
        with amp_autocast():
            ...
            #with open('./utils/model_config.txt', 'w') as f:
                #f.write(model)
        loss = output['loss']
