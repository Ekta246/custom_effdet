...
#MSECE
'''A script to convert labelbox annotations to particular form of annotations for training phase'''
import json
import cv2
import numpy as np
import os
#data_dir='./hom'
#data_catal={0:,1:,}
json_file_path='/export-2020-11-26T08_00_02.265Z.json'
...
'''A script to make custom annotations for test set '''
...
image_path='AI_current/vdot/vdot/Just_400/others_set'
