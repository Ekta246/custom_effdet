...
from vdot_test import VdotTestDataset
...
parser = argparse.ArgumentParser(description='PyTorch VDOT Validation')   
parser.add_argument('data', metavar='DIR',
                    help='path to dataset')
parser.add_argument('--anno', default='others_mix',
                    help='mscoco annotation set (one of val2017, train2017, test-dev2017)')
parser.add_argument('--model', '-m', metavar='MODEL', default='efficientdet_d0',
                    help='model architecture (default: tf_efficientdet_d1)')
add_bool_arg(parser, 'redundant-bias', default=None,
                    help='override model config for redundant bias layers')
parser.add_argument('-j', '--workers', default=8, type=int, metavar='N',
                    help='number of data loading workers (default: 4)')
parser.add_argument('-bs', '--batches-size', default=128, type=int,
...
parser.add_argument('--checkpoint', default='./vdot_new_836_2.pth', type=str, metavar='PATH',
